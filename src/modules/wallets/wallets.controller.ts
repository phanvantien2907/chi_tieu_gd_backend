...
export class WalletsController {
  ...
  @ApiOperation({
    summary: 'Tạo ví mới',
    description: 'Tạo ví mới, mỗi ví tượng trưng cho một nhóm hoặc gia đình',
  })
  ...
  @Get()
  @ApiOperation({
    summary: 'Lấy danh sách tất cả ví 1',
    description: 'Lấy danh sách tất cả ví trong hệ thống',
  })
  ...
  @Get('join/:id/')
  @ApiOperation({
    summary: 'Lấy QR code tham gia ví',
    description: 'Lấy ảnh QR code để tham gia ví để xem sau khi tạo',
  })
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Lấy thông tin ví theo ID',
    description: 'Lấy thông tin chi tiết của một ví theo ID',
  })
  ...
  @Patch('update/:id')
  @ApiOperation({
    summary: 'Cập nhật thông tin ví theo ID',
    description: 'Cập nhật thông tin của một ví theo ID',
  })
  @ApiNotFoundResponse({ description: 'Không tìm thấy ví' })
  @ApiOkResponse({ description: 'Cập nhật thông tin ví thành công' })
  @ApiBadRequestResponse({
    description: 'Dữ liệu không hợp lệ hoặc cập nhật ví thất bại',
  })
