...
export class CategoriesController {
  ...
  @ApiOperation({
    ...
    description: 'Tạo danh mục mới cho một ví cụ thể',
  })
  ...
  @ApiOperation({
    ...
    description: 'Lấy danh sách tất cả danh mục trong tất cả các ví',
  })
  ...
  @ApiOperation({
    ...
    description: 'Lấy thông tin chi tiết của một danh mục theo ID danh mục',
  })
  ...
  @ApiOperation({
    ...
    description: 'Cập nhật thông tin của một danh mục theo ID',
  })
  @ApiNotFoundResponse({ description: 'Không tìm thấy danh mục' })
  @ApiOkResponse({ description: 'Cập nhật thông tin danh mục thành công' })
  @ApiBadRequestResponse({
    description: 'Dữ liệu không hợp lệ hoặc cập nhật danh mục thất bại',
  })
  update(
    @Param('id') id: string,
