...
export class ExpenseSplitsController {
  ...
  @Get()
  @ApiOperation({
    summary: 'Lấy tất cả khoản chia chưa thanh toán',
    description:
      'Lấy danh sách tất cả các khoản chia chưa được thanh toán trong hệ thống',
  })
  findAll() {
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Lấy khoản chia theo ID',
    description: 'Lấy thông tin chi tiết của một khoản chia theo ID',
  })
  ...
  @Delete(':id')
  @ApiOperation({
    summary: 'Xoá khoản chia theo ID',
    description:
      'Xoá một khoản chia theo ID, thực chất là đánh dấu khoản chia đó đã được thanh toán',
  })
